...
class BottomNavShape(
    private val cornerRadius: Float, // Rounded corners at the top of the panel
    ...
    override fun createOutline(
        ...
        // baseRect: Creates a rounded rectangle covering the entire size, with rounded top corners.
        // This is the basic shape of the bottom navigation.
        ...
        // rect1: Creates a rectangle from the left edge to just before the center "dock", filling the full height.
        // Will be cut later to add a corner radius
        ...
        // circle: Creates a circle at the center, just above the bottom navigation,
        // creating the "dock" for the floating action button.
